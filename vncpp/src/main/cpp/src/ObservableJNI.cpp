...
void ObservableJNI::notifyFinishConnection() {
    getEnviroment();
    observer_class = env->GetObjectClass(this->observer_object);
    jmethodID updateFinishConnection = env->GetMethodID(observer_class, "updateFinishConnection",
                                                        "()V");
...
void ObservableJNI::getBitmapObject() {
    if (bitmap_object == NULL) {
        ...
        jfieldID screen_fieldID = env->GetFieldID(observer_class, "screen",
                                                  "Les/farfuteam/vncpp/model/Screen;");
...
char *ObservableJNI::notifyAskPass() {
    getEnviroment();
    observer_class = env->GetObjectClass(this->observer_object);
    jmethodID updateAskPass = env->GetMethodID(observer_class, "updateAskPass",
                                               "()Ljava/lang/String;");
